...
namespace App\Models {
    ...
    /**
     * App\Models\MateriaPrima
     *
     * @property string $fecha_registro
     * @property mixed $estado
     * @property \Illuminate\Support\Carbon|null $fecha_vencimiento
     * @property mixed $id_unidad
     * @property float $stock_minimo
     * @property float $existencia_actual
     * @property string $nombre
     * @property string $codigo
     * @property int $id_materia
     * @property-read \App\Models\UnidadMedida $unidadMedida
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MovimientoMateria> $movimientos
     * @property-read int|null $movimientos_count
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereIdMateria($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereCodigo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereExistenciaActual($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereStockMinimo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereIdUnidad($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereFechaVencimiento($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereEstado($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima whereFechaRegistro($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MateriaPrima>|MateriaPrima query()
     ...
     */
    class MateriaPrima extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\MovimientoMateria
     *
     * @property string|null $usuario
     * @property \Illuminate\Support\Carbon $fecha
     * @property string|null $razon
     * @property float $existencia_nueva
     * @property float $existencia_anterior
     * @property float $cantidad
     * @property mixed $id_tipo_movimiento
     * @property mixed $id_materia
     * @property int $id_movimiento
     * @property-read \App\Models\MateriaPrima $materiaPrima
     * @property-read \App\Models\TipoMovimiento $tipoMovimiento
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereIdMovimiento($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereIdMateria($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereIdTipoMovimiento($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereCantidad($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereExistenciaAnterior($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereExistenciaNueva($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereRazon($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereFecha($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria whereUsuario($value)
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<MovimientoMateria>|MovimientoMateria query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class MovimientoMateria extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\TipoMovimiento
     *
     * @property mixed $afecta_stock
     * @property string $nombre
     * @property int $id_tipo_movimiento
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MovimientoMateria> $movimientos
     * @property-read int|null $movimientos_count
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento whereIdTipoMovimiento($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento whereAfectaStock($value)
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<TipoMovimiento>|TipoMovimiento query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class TipoMovimiento extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\MateriaPrima> $materiasPrimas
     * @property-read int|null $materias_primas_count
     * @method static \Illuminate\Database\Eloquent\Builder<UnidadMedida>|UnidadMedida whereIdUnidad($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UnidadMedida>|UnidadMedida whereNombre($value)
     * @method static \Illuminate\Database\Eloquent\Builder<UnidadMedida>|UnidadMedida whereAbreviatura($value)
     ...
     * @property mixed $tipo_usuario
     * @property int $id_usuario
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereIdUsuario($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereTipoUsuario($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereUsuario($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario wherePassword($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereTelefono($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereDireccion($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereCorreo($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereFoto($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Usuario>|Usuario whereEstado($value)
