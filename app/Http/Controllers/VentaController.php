...
class VentaController extends Controller
{
    ...
    {
        $clientes = DB::table('cliente')->select('id_cliente as id', DB::raw('CONCAT(nombre, " ", COALESCE(apellido, "")) as name'))->get();
...
$datos = DB::table("venta")
            ...
            ->select("venta.*", DB::raw("' ' as foto"), "cliente.nombre as cliente",
...
$venta = DB::table('venta')
    ...
    public function update(Request $request, string $id)
    {
        ...
        // Delete old detalles and restore stock (simplificado: no restore exacto, ya que multi)
    ...
    public function destroy(string $id)
    {
        ...
        return $eliminar ? redirect()->route("ventas.index")->with("CORRECTO", "Venta eliminada correctamente") : redirect()->route("ventas.index")->with("INCORRECTO", "Error al eliminar");
    }
...
$datos = DB::select(" SELECT venta.*, cliente.nombre as cliente, producto.nombre as cajero
    ...
    public function registrarFotoVenta(Request $request)
    {
        ...
        return $actualizar == 1 ? back()->with("CORRECTO", "Foto actualizada correctamente") : back()->with("INCORRECTO", "Error al actualizar foto");
    }
...
public function reporte(Request $request)
    {
        ...
        return view('vistas/ventas/reporteVentas', compact('total_ventas', 'total_ingresos', 'top_productos', 'fechas', 'ingresos_fechas', 'fecha_desde', 'fecha_hasta'));
    }
...
public function storeCliente(Request $request)
    ...
    public function reportePDF(Request $request)
    {
        ...
        $pdf = \Barryvdh\DomPDF\Facade\Pdf::loadView('vistas/ventas/reporteVentasPDF', compact(
            'total_ventas', 'total_ingresos', 'top_productos', 'fecha_desde', 'fecha_hasta'
        ));
