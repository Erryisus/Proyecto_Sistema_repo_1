        ...
        <div class="row mb-4">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="input-group shadow-sm">
                    ...
                    <input type="number" name="bajo_stock" value="{{ $bajo_stock }}" min="0"
                        class="form-control border-0 shadow-none" placeholder="Stock mínimo">
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 mb-3 d-flex align-items-end">
                <a href="{{ route('producto.reporte.pdf', ['bajo_stock' => $bajo_stock]) }}"
                    class="btn btn-success w-100 shadow-lg">
            ...
            <div class="card h-100 border-0 shadow-lg hover-lift">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <h5 class="text-success mb-0">Valor Total Inventario (Bs.)</h5>
                        </div>
                    </div>
                    <h2 class="display-6 fw-bold text-success mb-0">Bs. {{ number_format($total_value_bs, 2) }}</h2>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 shadow-lg hover-lift">
                <div class="card-body p-4">
                    <div class="d-flex align-items-center mb-2">
                        ...
                        <div>
                            <h5 class="text-success mb-0">Valor Total Inventario (USD)</h5>
                        </div>
                    </div>
                    <h2 class="display-6 fw-bold text-success mb-0">USD. {{ number_format($total_value_usd, 2) }}</h2>
                </div>
            </div>
        </div>
