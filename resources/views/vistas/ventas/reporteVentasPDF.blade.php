...
<body>
    <div class="header">
        ...
        <p><strong>Período:</strong> {{ \Carbon\Carbon::parse($fecha_desde)->format('d/m/Y') }} al
            {{ \Carbon\Carbon::parse($fecha_hasta)->format('d/m/Y') }}</p>
    ...
    <div class="summary">
        ...
        <div class="metric">
            <strong>$ {{ number_format($total_ingresos_usd, 2) }}</strong><br>
    ...
    <table>
        ...
        <tbody>
            @foreach ($ventas as $venta)
                <tr>
                    ...
                    <td class="text-right">Bs. {{ number_format($venta->total, 2) }} ( $
                        {{ number_format($venta->total_usd ?? 0, 2) }} )</td>
        ...
        <tfoot>
            <tr class="total-row">
                <td colspan="5"></td>
                <td class="text-right"><strong>Bs. {{ number_format($total_ingresos, 2) }} ( $
                        {{ number_format($total_ingresos_usd ?? 0, 2) }} )</strong></td>
                <td></td>
            </tr>
        </tfoot>
    </table>
