...
@section('content')
    ...
    <form method="GET" action="{{ route('venta.reporte') }}">
        <div class="row mb-4">
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="input-group shadow-sm">
                    ...
                    <input type="date" name="fecha_desde" value="{{ request('fecha_desde') }}"
                        class="form-control border-0 shadow-none" placeholder="Desde">
                </div>
            </div>
            <div class="col-lg-3 col-md-6 mb-3">
                <div class="input-group shadow-sm">
                    ...
                    <input type="date" name="fecha_hasta" value="{{ request('fecha_hasta') }}"
                        class="form-control border-0 shadow-none" placeholder="Hasta">
                </div>
            </div>
            ...
            <div class="col-lg-2 col-md-6 mb-3 d-flex align-items-end">
                <a href="{{ route('venta.reporte.pdf', ['fecha_desde' => request('fecha_desde', date('Y-m-01')), 'fecha_hasta' => request('fecha_hasta', date('Y-m-d'))]) }}"
                    class="btn btn-success w-100 shadow-lg" target="_blank">
        ...
        <div class="col-xl-3 col-lg-6">
            <div class="card h-100 border-0 shadow-lg hover-lift">
                <div class="card-body text-center p-4">
                    ...
                    <h2 class="display-5 fw-bold text-primary mb-1">$ {{ number_format($total_ingresos_usd, 2) }}</h2>
                    <p class="text-muted h6 mb-0">Ingresos Totales (USD)</p>
                </div>
            </div>
        </div>
